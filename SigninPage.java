...
public class SigninPage {
	...
	public void clickLoginButton() {
		// objBaseTest.getObjSeleniumWrapperFunction().setImplicitlyWait(5);
	...
	public void setPasswordOnSigninPage(String strPassword) {
		Assert.assertTrue(objBaseTest.getObjSeleniumWrapperFunction().setText(loc_inpPassword, strPassword));
	...
	{
		objBaseTest.getObjSeleniumWrapperFunction().verifyBrokenLinks();
	}

	/*
	 * public void getSigninButtonTextOnSigninPage() { String strSigninText =
	 * objBaseTest.getDriver().findElement(loc_btnLogin).getText();
